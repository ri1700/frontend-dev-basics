...
console.log("===== [04] MyMathe 생성자 함수로 생성한 객체의 proto 객체");
var math = new MyMath("my math");
console.log(math.__proto__ === MyMath.prototype);


console.log("===== [05] 리터럴 {}로 정의한 객체의 protot 객체 ");
var obj = {};
console.log(obj.__proto__ === Object.prototype);


console.log("===== [06] prototype 객체 속성 접근");
console.log(math.add(10, -20), math.PI);


console.log("===== [07] prototype 객체 속성 접근 - 오버라이드");
math.add = function(a, b){
    console.log("add called by ");
...
console.log("===== [09] prototype 객체의 proto 속성 확인");
console.log(MyMath.prototype.__proto__ === Object.prototype);


console.log("===== [10] Object.prototype 객체 속성 사용");
...
console.log("===== [11] function 객체의 proto 확인");
console.log(MyMath.__proto__ === Function.prototype);


console.log("===== [12] Function.prototype 객체의 속성 사용");
